...
function endre()
{
    ...
    document.body.style.body.backgroundColor = "#000000"
    document.body.style.body.color = "#FFFFFF"
    tegnGalge();

    nytt = true
    if(nytt == true)
    {
        //endre til forrige utseende
        ctx.strokeStyle = "#000000"
        document.body.style.body.backgroundColor = "#b2a69f"
        document.body.style.body.color = "#000000"
        tegnGalge();
        nytt = false;
        return;
    }
...
function mottaBokstav()
{
    ...
    if(sjekk == true && gjettetBokstav.length == 1)
    {
        ...
        alert("du kan kun skrive inn bokastaver og et tegn");

        document.getElementById("txtBokstaver").value = "";
        document.getElementById("txtBokstaver").focus();
...
function highscore()
{
    ...
    {
        //hvis den finnes: gjør vi om fra streng til array, score er på indexplass: 1
    ...
    //sjekke om score er bedre (lavere) enn lagret highscore, localstorage er stringvariabler, derfor må
    //vi konvertere det til tall med partInt, da dette er et desimaltall
...
//skrive ut lagret highscore med oppstart 
if(localStorage.beste)
{
    var beste = JSON.parse(localStorage.getItem("beste"))
    document.getElementById("highscore").innerHTML = beste[0] + beste[1] + beste[2] + beste[3] + ":" + beste[4] 
}
else{
    document.getElementById("highscore").innerHTML = "Ingen highscore finnes"
}
